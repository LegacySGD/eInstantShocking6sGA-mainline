...
public class Shocking6sGAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Shocking6sGAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Shocking6sGAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Shocking6sGAIW/InitOutcome.xml").getDocumentElement();
